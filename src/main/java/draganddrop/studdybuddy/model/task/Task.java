...
public class Task implements Comparable<Task> {
    ...
    public Task(draganddrop.studdybuddy.model.module.Module module, TaskType taskType, String taskName, String taskDescription, double weight,
    ...
    public draganddrop.studdybuddy.model.module.Module getModule() {
        return module;
    }

    public void setModule(draganddrop.studdybuddy.model.module.Module module) {
        this.module = module;
    }
    ...
    public String getTimeString() {
        ...
        if (dateTimes.length == 1) {
            timeString = draganddrop.studdybuddy.logic.parser.TimeParser.getDateTimeString(dateTimes[0]);
        } else if (dateTimes.length == 2) {
            timeString = draganddrop.studdybuddy.logic.parser.TimeParser.getDateTimeString(dateTimes[0]) + "-" + draganddrop.studdybuddy.logic.parser.TimeParser.getDateTimeString(dateTimes[0]);
        }
        return timeString;
    }
