...
public class UniquePersonList implements Iterable<Person> {
    ...
    public void add(Person toAdd) {
        ...
        if (contains(toAdd)) {
            throw new draganddrop.studdybuddy.model.person.exceptions.DuplicatePersonException();
        }
    ...
    public void setPerson(Person target, Person editedPerson) {
        ...
        if (index == -1) {
            throw new draganddrop.studdybuddy.model.person.exceptions.PersonNotFoundException();
        }
