...
public class DueSoonTaskCard extends UiPart<Region> {
    ...
    public final draganddrop.studdybuddy.model.task.Task task;
    ...
    public DueSoonTaskCard(draganddrop.studdybuddy.model.task.Task task, int displayedIndex) {
        super(FXML);
        this.task = task;
        ...
        creationDateTime.setText("\tCreated: "
                + draganddrop.studdybuddy.logic.parser.TimeParser.getDateTimeString(task.getCreationDateTime()));
     ...
     * @param task
     */
    private void renderTask(draganddrop.studdybuddy.model.task.Task task) {
