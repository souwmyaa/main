...
class JsonAdaptedTask {
    ...
    public JsonAdaptedTask(Task source) {
        ...
        taskFinishDateTime = source.getFinishDateTime() != null
            ? draganddrop.studdybuddy.logic.parser.TimeParser.getDateTimeString(source.getFinishDateTime())
            : "";
        ...
        taskCreationDateTime = draganddrop.studdybuddy.logic.parser.TimeParser.getDateTimeString(source.getCreationDateTime());
    }
    ...
    public Task toModelType() throws IllegalValueException {
        ...
        if (timeTerms.length == 2) {
            ...
            dateTimes[0] = draganddrop.studdybuddy.logic.parser.TimeParser.parseDateTime(timeTerms[0]);
            dateTimes[1] = draganddrop.studdybuddy.logic.parser.TimeParser.parseDateTime(timeTerms[1]);
        } else {
            dateTimes = new LocalDateTime[1];
            dateTimes[0] = draganddrop.studdybuddy.logic.parser.TimeParser.parseDateTime(timeTerms[0]);
        }

        LocalDateTime creationDateTime = draganddrop.studdybuddy.logic.parser.TimeParser.parseDateTime(taskCreationDateTime);

        Task data = new Task(new draganddrop.studdybuddy.model.module.Module(moduleCode), TaskType.getType(taskType),
        ...
        if (!taskFinishDateTime.isBlank()) {
            LocalDateTime finishDateTime = draganddrop.studdybuddy.logic.parser.TimeParser.parseDateTime(taskFinishDateTime);
