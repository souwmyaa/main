...
import static draganddrop.studdybuddy.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
import static draganddrop.studdybuddy.testutil.TypicalPersons.AMY;
...
public class LogicManagerTest {
    ...
    public void getFilteredPersonList_modifyList_throwsUnsupportedOperationException() {
        draganddrop.studdybuddy.testutil.Assert.assertThrows(UnsupportedOperationException.class, () -> logic.getFilteredPersonList().remove(0));
    }
    ...
    private void assertCommandFailure(String inputCommand, Class<? extends Throwable> expectedException,
        ...
        draganddrop.studdybuddy.testutil.Assert.assertThrows(expectedException, expectedMessage, () -> logic.execute(inputCommand));
        assertEquals(expectedModel, model);
    }
